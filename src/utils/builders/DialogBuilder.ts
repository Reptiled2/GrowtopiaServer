export class DialogBuilder {
  ...
  /**
   * Adds a tab button with an icon
   * @param {string} tabid Id of the tab
   * @param {string} tabName Name of the tab
   * @param {string} rttex The rttex of the tab
   * @param {string} xPos X Position of the tab texture
   * @param {string} yPos Y Position of the tab texture
   * @returns {DialogBuilder}
   */
  public addTabButton(tabid: string, tabName: string, rttex: string, xPos: string, yPos: string): DialogBuilder {
    this.#str += `add_tab_button|${tabid}|${tabName}|${rttex}||${xPos}|${yPos}|0|0||||-1|-1|||0|0|\n`;
    return this;
  }
  ...
  /**
   * Adds a banner
   * @param {string} rttex The rttex of the banner
   * @param {string} xPos X Position of the banner texture
   * @param {string} yPos Y Position of the banner texture
   * @returns {DialogBuilder}
   */
  public addBanner(rttex: string, xPos: string, yPos: string): DialogBuilder {
    this.#str += `add_banner|${rttex}|${xPos}|${yPos}|\n`
    return this;
  }
   ...
   * @param {string} text The text in the button
   * @param {string} rttex The rttex of the button
   * @param {string} description The description of the button
   * @param {string} posX The x position of the rttex
   * @param {string} posY The y position of the rttex
   * @param {string} price Price of the item
   * @returns {DialogBuilder}
   */

  public addShopButton(name: string, text: string, rttex: string, description: string, posX: string, posY: string, price: string): DialogBuilder {
    this.#str += `add_button|${name}|${text}|${rttex}|${description}|${posX}|${posY}|${price}|0|||-1|-1||-1|-1||1||||||0|0|\n`;
    return this;
  }
  ...
  public addImageButton(name: string, rttex: string): DialogBuilder {
    this.#str += `add_image_button|image_button|${rttex}|bannerlayout|OPENDIALOG|${name}\n`;
    return this;
  }
  ...
  public enableTabs(str: string): DialogBuilder {
    this.#str += `enable_tabs|${str}\n`;
    return this;
  }
